export default {
  ...
  pageDescription: {
    realtimeSpend: 'DewBee의 실시간 지출내역 페이지 입니다.',
    ...
    profile: '프로필 설정페이지 입니다.',
    inquiry: 'DewBee의 문의하기입니다.',
    chat: 'DewBee의 문의채팅 페이지 입니다.',
    patchNote: 'DewBee의 패치노트 입니다.',
    familyService: 'DewBee의 자매품 입니다.',
    policy: 'DewBee의 개인정보 처리방침 입니다.',
  },
  menu: {
    main: '메인',
    profile: '프로필',
  ...
  message: {
    ...
    naverNoUseGoogle: '네이버 앱에서는 구글 로그인을 사용할 수 없어요!',
    loginFailed: {
      title: '로그인 실패',
